...
def main():
    ...
    while run:
        clock.tick(60) # Refresh rate in Hz. Remove for maximum sorting speed (note that your processor or operating system may limit the refresh rate, regardless of the number here.)
